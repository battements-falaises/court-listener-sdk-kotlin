...
package com.court_listener_sdk.api.core
...
private constructor(
     ...
     *
     * Use the one published in `court-listener-kotlin-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [com.court_listener_sdk.api.core.jsonMapper]. The default is usually sufficient
     ...
     *
     * Defaults to the production environment: `https://www.courtlistener.com/api/rest/v4`.
     */
    ...
    companion object {
        ...
        const val PRODUCTION_URL = "https://www.courtlistener.com/api/rest/v4"
    ...
    class Builder internal constructor() {
         ...
         * The Jackson JSON mapper to use for serializing and deserializing JSON.
         *
         * Defaults to [com.court_listener_sdk.api.core.jsonMapper]. The default is usually
        ...
        fun fromEnv() = apply {
            (System.getProperty("courtlistener.baseUrl")
                ...
                ?.let { baseUrl(it) }
            (System.getProperty("courtlistener.apiKey") ?: System.getenv("COURT_LISTENER_API_KEY"))
                ?.let { apiKey(it) }
            (System.getProperty("courtlistener.username")
                    ?: System.getenv("COURT_LISTENER_USERNAME"))
                ?.let { username(it) }
        ...
        fun build(): ClientOptions {
            ...
            apiKey?.let {
                if (!it.isEmpty()) {
                    headers.replace("Authorization", "Token $it")
                }
            }
