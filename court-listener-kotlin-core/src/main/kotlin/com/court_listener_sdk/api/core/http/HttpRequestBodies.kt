...
import com.court_listener_sdk.api.core.MultipartField
...
private fun serializePart(name: String, node: JsonNode): Sequence<Pair<String, InputStream>> =
    when (node.nodeType) {
                    ...
                    node
                        ...
                        .mapNotNull { element ->
                            when (element.nodeType) {
                                ...
                                JsonNodeType.OBJECT,
                                JsonNodeType.POJO ->
                                    throw CourtListenerInvalidDataException(
        ...
        JsonNodeType.POJO,
        null ->
            throw CourtListenerInvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
    }
