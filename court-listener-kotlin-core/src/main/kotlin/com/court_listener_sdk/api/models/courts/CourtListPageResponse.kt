...
class CourtListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val count: JsonField<String>,
    private val next: JsonField<String>,
    private val previous: JsonField<String>,
    private val results: JsonField<List<Court>>,
    ...
    private constructor(
        ...
        @JsonProperty("results") @ExcludeMissing results: JsonField<List<Court>> = JsonMissing.of(),
     ...
     *   the server responded with an unexpected value).
     */
    fun results(): List<Court>? = results.getNullable("results")
     ...
     */
    @JsonProperty("results") @ExcludeMissing fun _results(): JsonField<List<Court>> = results
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CourtListPageResponse]. */
        fun builder() = Builder()
    }

    /** A builder for [CourtListPageResponse]. */
    class Builder internal constructor() {

        private var count: JsonField<String> = JsonMissing.of()
        private var next: JsonField<String> = JsonMissing.of()
        private var previous: JsonField<String> = JsonMissing.of()
        private var results: JsonField<MutableList<Court>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(courtListPageResponse: CourtListPageResponse) = apply {
            count = courtListPageResponse.count
            next = courtListPageResponse.next
            previous = courtListPageResponse.previous
            results = courtListPageResponse.results.map { it.toMutableList() }
            additionalProperties = courtListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        fun results(results: List<Court>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<Court>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun results(results: JsonField<List<Court>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [Court] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: Court) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [CourtListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CourtListPageResponse =
            CourtListPageResponse(
                count,
                next,
                previous,
     ...
     *   expected type.
     */
    fun validate(): CourtListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CourtListPageResponse &&
            count == other.count &&
            next == other.next &&
    ...
    override fun toString() =
        "CourtListPageResponse{count=$count, next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
}
