...
/**
 * Look up a cluster by its ID. The cluster ID matches the ID used in CourtListener case law URLs
 * (e.g. `/opinion/2812209/obergefell-v-hodges/` corresponds to cluster ID `2812209`).
 */
...
private constructor(
    ...
    companion object {
        ...
        fun none(): ClusterRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(clusterRetrieveParams: ClusterRetrieveParams) = apply {
            id = clusterRetrieveParams.id
            fields = clusterRetrieveParams.fields
            format = clusterRetrieveParams.format
            omit = clusterRetrieveParams.omit
    ...
    override fun toString() =
        "ClusterRetrieveParams{id=$id, fields=$fields, format=$format, omit=$omit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
