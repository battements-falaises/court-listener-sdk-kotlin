...
class DocketListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val count: JsonField<String>,
    private val next: JsonField<String>,
    private val previous: JsonField<String>,
    private val results: JsonField<List<Docket>>,
    ...
    private constructor(
        ...
        @JsonProperty("results") @ExcludeMissing results: JsonField<List<Docket>> = JsonMissing.of(),
     ...
     *   the server responded with an unexpected value).
     */
    fun results(): List<Docket>? = results.getNullable("results")
     ...
     */
    @JsonProperty("results") @ExcludeMissing fun _results(): JsonField<List<Docket>> = results
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [DocketListPageResponse]. */
        fun builder() = Builder()
    }

    /** A builder for [DocketListPageResponse]. */
    class Builder internal constructor() {

        private var count: JsonField<String> = JsonMissing.of()
        private var next: JsonField<String> = JsonMissing.of()
        private var previous: JsonField<String> = JsonMissing.of()
        private var results: JsonField<MutableList<Docket>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(docketListPageResponse: DocketListPageResponse) = apply {
            count = docketListPageResponse.count
            next = docketListPageResponse.next
            previous = docketListPageResponse.previous
            results = docketListPageResponse.results.map { it.toMutableList() }
            additionalProperties = docketListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        fun results(results: List<Docket>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<Docket>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun results(results: JsonField<List<Docket>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [Docket] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: Docket) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [DocketListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DocketListPageResponse =
            DocketListPageResponse(
                count,
                next,
                previous,
    ...
    fun validate(): DocketListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DocketListPageResponse &&
            count == other.count &&
            next == other.next &&
    ...
    override fun toString() =
        "DocketListPageResponse{count=$count, next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
}
