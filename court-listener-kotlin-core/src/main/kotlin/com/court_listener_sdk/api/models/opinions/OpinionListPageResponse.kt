...
class OpinionListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val count: JsonField<String>,
    private val next: JsonField<String>,
    private val previous: JsonField<String>,
    private val results: JsonField<List<Opinion>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<Opinion>> = JsonMissing.of(),
     ...
     *   the server responded with an unexpected value).
     */
    fun results(): List<Opinion>? = results.getNullable("results")
     ...
     */
    @JsonProperty("results") @ExcludeMissing fun _results(): JsonField<List<Opinion>> = results
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [OpinionListPageResponse]. */
        fun builder() = Builder()
    }

    /** A builder for [OpinionListPageResponse]. */
    class Builder internal constructor() {

        private var count: JsonField<String> = JsonMissing.of()
        private var next: JsonField<String> = JsonMissing.of()
        private var previous: JsonField<String> = JsonMissing.of()
        private var results: JsonField<MutableList<Opinion>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(opinionListPageResponse: OpinionListPageResponse) = apply {
            count = opinionListPageResponse.count
            next = opinionListPageResponse.next
            previous = opinionListPageResponse.previous
            results = opinionListPageResponse.results.map { it.toMutableList() }
            additionalProperties = opinionListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        fun results(results: List<Opinion>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<Opinion>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun results(results: JsonField<List<Opinion>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [Opinion] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: Opinion) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [OpinionListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OpinionListPageResponse =
            OpinionListPageResponse(
                count,
                next,
                previous,
     ...
     *   expected type.
     */
    fun validate(): OpinionListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OpinionListPageResponse &&
            count == other.count &&
            next == other.next &&
    ...
    override fun toString() =
        "OpinionListPageResponse{count=$count, next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
}
