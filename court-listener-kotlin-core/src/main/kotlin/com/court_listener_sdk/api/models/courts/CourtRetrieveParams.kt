...
private constructor(
    ...
    companion object {
        ...
        fun none(): CourtRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CourtRetrieveParams]. */
        fun builder() = Builder()
    }

    /** A builder for [CourtRetrieveParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(courtRetrieveParams: CourtRetrieveParams) = apply {
            id = courtRetrieveParams.id
            fields = courtRetrieveParams.fields
            format = courtRetrieveParams.format
            omit = courtRetrieveParams.omit
            additionalHeaders = courtRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = courtRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CourtRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CourtRetrieveParams =
            CourtRetrieveParams(
                id,
                fields,
                format,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CourtRetrieveParams &&
            id == other.id &&
            fields == other.fields &&
            format == other.format &&
            omit == other.omit &&
    ...
    override fun toString() =
        "CourtRetrieveParams{id=$id, fields=$fields, format=$format, omit=$omit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
