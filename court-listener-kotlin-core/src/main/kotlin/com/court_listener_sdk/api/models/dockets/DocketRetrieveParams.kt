...
private constructor(
    ...
    companion object {
        ...
        fun none(): DocketRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DocketRetrieveParams]. */
        fun builder() = Builder()
    }

    /** A builder for [DocketRetrieveParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(docketRetrieveParams: DocketRetrieveParams) = apply {
            id = docketRetrieveParams.id
            fields = docketRetrieveParams.fields
            format = docketRetrieveParams.format
            omit = docketRetrieveParams.omit
            additionalHeaders = docketRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = docketRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DocketRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DocketRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DocketRetrieveParams &&
            id == other.id &&
            fields == other.fields &&
            format == other.format &&
            omit == other.omit &&
    ...
    override fun toString() =
        "DocketRetrieveParams{id=$id, fields=$fields, format=$format, omit=$omit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
