...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.court_listener_sdk.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.court_listener_sdk.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.court_listener_sdk.api.** {
    <init>(...);
