...
/**
 * A class that allows building an instance of [CourtListenerClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class CourtListenerOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [CourtListenerClientAsync]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): CourtListenerClientAsync = builder().fromEnv().build()
    }

    /** A builder for [CourtListenerOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [CourtListenerClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CourtListenerClientAsync =
            CourtListenerClientAsyncImpl(
                clientOptions
                    .httpClient(
