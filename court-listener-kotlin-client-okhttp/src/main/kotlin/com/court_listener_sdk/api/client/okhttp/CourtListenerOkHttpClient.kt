...
package com.court_listener_sdk.api.client.okhttp

import com.court_listener_sdk.api.client.CourtListenerClient
import com.court_listener_sdk.api.client.CourtListenerClientImpl
...
/**
 * A class that allows building an instance of [CourtListenerClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class CourtListenerOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [CourtListenerClient]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): CourtListenerClient = builder().fromEnv().build()
    }

    /** A builder for [CourtListenerOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [CourtListenerClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CourtListenerClient =
            CourtListenerClientImpl(
                clientOptions
                    .httpClient(
